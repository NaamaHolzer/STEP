...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredWithBusyOptional() {
    // Have each person have different events. In addition have an optional attendee who's busy the whole day. We should see two options because each person has
    // split the restricted times and the optional attendee is never available.
    //
    // Events  :       |--A--|     |--B--|
    //           |----------C-optional---------|
    // Day     : |-----------------------------|
  ...
  public void everyAttendeeIsConsideredWithOptional() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. The middle range shouldn't be returned because the optional attendee is not available during that time.
    //
    // Events  :       |--A--||-c-||--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|                 |--2--|
  ...
  public void justEnoughRoomWithOptional() {
    ...
    // have the meeting. Have an optional attendee who's busy at that range. The optional attendee should be ignored.
    //
    // Events  : |--A--||B|  |----A----|
    // Day     : |---------------------|
    // Options :       |-----|
  ...
  public void noMandatoryWithGaps() {
    // Have two optional attendees with several gaps in their schedules. Those gaps should be returned.
    //
    // Events  :     |-A-|   |-B-|
    // Day     : |---------------------|
    // Options : |-1-|   |-2-|   |--3--|
  ...
  public void noMandatoryNoGaps() {
    // Have two optional attendees with no gaps in their schedules. The whole day should be returned
    //
    // Events  : |----A----||----B-----|
    // Day     : |---------------------|
    // Options : 
